...
import { ArrowDownRight, ArrowUpRight, Download, ExternalLink, Github, Mail, Menu, X } from "lucide-react";
...
function Index() {
  ...
  const skills = [
    ...
    ["Backend", "PHP", "Laravel", "Node.js", "REST APIs", "Sanctum"],
      ...
      {loading && (
        <motion.div exit={{ y: "-100%" }} className="fixed inset-0 z-100 grid place-items-center bg-background">
          <div className="w-[min(80vw,420px)]">
            <div className="mb-4 flex items-end justify-between font-mono text-xs uppercase text-muted-foreground"><span>Ali Akbar</span><span>Portfolio / 26</span></div>
    ...
    >
      ...
      <div className="mt-8 flex max-w-2xl flex-col items-center gap-7">
        <p className="max-w-xl text-sm leading-7 text-muted-foreground sm:text-base">
          I build clean, scalable digital products where robust engineering
          meets thoughtful interaction and emerging AI technologies.
        </p>
    ...
    ALI AKBAR — ALI AKBAR —
          ...
          <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.42fr_1fr]">
            ...
            <div>
              ...
              <div className="mt-12 grid gap-8 border-t border-border pt-8 sm:grid-cols-2">
                <p className="text-sm leading-7 text-muted-foreground">Full-Stack Developer experienced in PHP, Laravel, Node.js, and React.js, with a focus on REST APIs, MVC architecture, authentication, and well-designed databases.</p>
        ...
        <section id="work" className="px-5 py-24 sm:px-8 lg:px-12 lg:py-36">
          <div className="mx-auto max-w-[1280px]">
            <div className="mb-16 flex items-end justify-between border-b border-border pb-6"><div><p className="font-mono text-xs uppercase text-primary">02 / Selected Work</p><h2 className="mt-4 text-4xl font-semibold sm:text-6xl">Built to perform.</h2></div><span className="hidden font-mono text-xs text-muted-foreground sm:block">2025—2026</span></div>
            <div>
              {projects.map((project) => <motion.article key={project.number} initial={{ opacity: 0, y: 36 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.65 }} data-cursor className="group relative grid gap-7 overflow-hidden border-b border-border py-10 lg:min-h-64 lg:grid-cols-[80px_1.08fr_0.92fr_48px] lg:items-start lg:py-14">
